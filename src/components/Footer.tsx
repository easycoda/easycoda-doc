...
export function Footer(): React.ReactElement {
  ...
  return (
    <footer
      role="contentinfo"
      className="border-t z-10 border-border mt-auto bg-card-foreground dark:bg-card py-8 px-4 sm:px-6 lg:px-8"
    >
      <div className="container mx-auto px-4 pt-8">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
          {/* Column 1 — Copyright */}
          <div className="flex flex-col gap-2">
            <span className="text-lg font-bold text-primary-foreground dark:text-primary">{siteConfig.title}</span>
            <p className="text-sm text-input dark:text-muted-foreground">{copyright}</p>
          </div>

          {/* Column 2 — Footer Links */}
          <div className='md:text-center'>
            <h3 className="mb-3 text-sm font-semibold text-primary-foreground dark:text-primary ">
              {t["footer.links"]}
